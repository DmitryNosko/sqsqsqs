...
static const char* CREATE_FEEDITEM_SQL = "CREATE TABLE IF NOT EXISTS FeedItem (ID INTEGER PRIMARY KEY AUTOINCREMENT, itemTitle TEXT, link TEXT, pubDate DATETIME, itemDescription TEXT, enclousure TEXT, imageURL TEXT, isFavorite BOOL NOT NULL DEFAULT 0, isReaded BOOL NOT NULL DEFAULT 0, isAvailable BOOL NOT NULL DEFAULT 0, resourceURL TEXT, resourceID INTEGER, FOREIGN KEY (resourceID) REFERENCES FeedResource(id))";
